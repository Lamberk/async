...
def has_collision(obstacle_corner, obstacle_size, obj_corner, obj_size=(1, 1)):
    ...
    return all(
        [
            obstacle_corner[0] < obj_corner[0] + obj_size[0],
            obstacle_corner[0] + obstacle_size[0] > obj_corner[0],
            obstacle_corner[1] < obj_corner[1] + obj_size[1],
            obstacle_corner[1] + obstacle_size[1] > obj_corner[1],
        ]
    )


def add_obstacle(state, row, column, rows_size, columns_size):
